...
async function start(){
  ...
  $("who").innerText = user?.email ? ("User: " + user.email) : "User: (tidak terdeteksi)";
...
document.addEventListener("DOMContentLoaded", ()=>{
  ...
  bindTap("btnMasuk", ()=>{ $("jenis").value = "Uang Masuk"; setJenisUI(); });
  bindTap("btnKeluar", ()=>{ $("jenis").value = "Uang Keluar"; setJenisUI(); });
